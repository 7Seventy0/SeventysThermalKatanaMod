...
namespace SeventysThermalKatanaMod
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            var myLoadedAssetBundle = AssetBundle.LoadFromFile(Path.Combine(Application.streamingAssetsPath, "thermalkatana"));
            if (myLoadedAssetBundle == null)
            {
                Debug.Log("Failed to load AssetBundle!");
                return;
            }
            var katana = myLoadedAssetBundle.LoadAsset<GameObject>("thermal_katana_2");
